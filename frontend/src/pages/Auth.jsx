      ...
      <div className={`auth-container ${isRegister ? 'register-mode' : 'login-mode'}`}>
        ...
        <div className="auth-info">
          ...
          <div className="info-content">
            {isRegister ? (
              <>
                <span className="info-label">GET STARTED</span>
                <h1>
                  Build better
                  <br />
                  <span>work habits.</span>
                ...
                <div className="info-features">
                  <div>
                    ...
                    <div>
                      <strong>Organize Tasks</strong>
                      <p>Keep all your work organized in one place.</p>
                    </div>
                  </div>
                  <div>
                    <span className="feature-icon">□</span>
                  ...
                  <div>
                    ...
                    <div>
                      <strong>Track Progress</strong>
                      <p>Monitor your productivity and stay on schedule.</p>
                    </div>
                  </div>
                </div>
              </>
              ...
              <>
                <span className="info-label">WELCOME BACK</span>
                <h1>
                  More clarity.
                  <br />
                  <span>More productivity.</span>
                ...
                <div className="login-message">
                  ...
                  <div>
                    <strong>Your workspace awaits.</strong>
                    <p>Your tasks, projects and progress are ready for you.</p>
                  </div>
                </div>
              </>
            )}
        ...
        <div className="auth-form-panel">
          <div className="switcher">
            <Link to="/login" className={!isRegister ? 'active' : ''}>Login</Link>
